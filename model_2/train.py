...
# ------------------ Load local library ----------------------------------
from models import track_generator
...
# model_path = f"./results/2024-10-22_20-09-30/model/0820000.pt"
...
for epoch in range(num_epoch):
    ...
    for x, (condition, pos_label) in loader:
        ...
        # x = torch.zeros((32, 2, 140)).to(device)
        # condition = torch.zeros((32, 3,28)).to(device)
        # pos_label = torch.zeros((32, 2), dtype=torch.int).to(device)
        y = (condition, pos_label)
